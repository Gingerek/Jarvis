...
| OBS Studio | record/stream/scenes/audio/status | obs-websocket 5.x persistent authenticated connection | UIA | built into OBS 28+ | OBS/obs-websocket terms | local WebSocket credential | interactive | high | VERIFIED live: OBS 32.2.2 / websocket 5.7.4 |
...
| Lightroom Classic | next/previous/rating/flag/navigation | official Lua SDK `LrSelection` over Jarvis loopback bridge | controlled input only outside SDK | Adobe SDK | Adobe terms | user/plugin | interactive | high | VERIFIED live on 15.5.1 |
| Lightroom Classic | exposure/contrast/highlights/shadows/whites/blacks/texture/clarity/dehaze/vibrance/saturation/temperature/tint | official Lua SDK `LrDevelopController` over Jarvis loopback bridge | UIA only for capabilities outside SDK | Adobe SDK | Adobe terms | user/plugin | interactive | high | VERIFIED live on 15.5.1 |
